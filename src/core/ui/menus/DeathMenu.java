...
public class DeathMenu implements Menu {
	...
	public void render() {
		...
		Game.getUserInterface().drawTextCentered(Game.WIDTH /2, 200, UserInterface.SECONDARY_FONT_SIZE, "Don't do that", new Color(.003f, .003f, .003f));
		Game.getUserInterface().drawTextCentered(Game.WIDTH /2, 250, UserInterface.SECONDARY_FONT_SIZE, "Press ENTER to continue...");
	}
